...
let c ="If you fail, never give up because FAIL means \"First Attempt In Learning\"."
console.log(c);
...
let i="Time and Tide wait for none";
...
let j="When life gives you lemons make lemonade";
...
let k="You must be the change you wish to see in the world.";
